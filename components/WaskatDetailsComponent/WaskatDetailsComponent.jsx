...
Height: ${customer.qad}
Chest: ${customer.baghal}
Waist: ${customer.kamar}
Shoulder: ${customer.shana}
Sleeve: ${customer.soreen}
Collar Type: ${customer.yakhan} (${customer.yakhanValue})
Special Instructions: ${customer.farmaish}
Registration Date: ${timeSinceRegistration}`;
      ...
      ToastAndroid.show("Error sharing customer details", ToastAndroid.SHORT);
    }
  };
